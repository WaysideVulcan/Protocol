...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L displayport_v8_1_7 -L lib_pkg_v1_0_3 -L lib_cdc_v1_0_2 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_5 -L xlconstant_v1_1_8 -L proc_sys_reset_v5_0_14 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_29 -L axi_vip_v1_1_15 -L dp_videoaxi4s_bridge_v1_0_2 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot v_dp_rxss1_0 xil_defaultlib.v_dp_rxss1_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim v_dp_rxss1_0 -key {Behavioral:sim_1:Functional:v_dp_rxss1_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b9b6.protoinst" -protoinst "protoinst_files/bd_ac35_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb v_dp_rxss1_0.wdb xsim.dir libdpi.so)
