...
module dpss_vck190_pt_clk_wizard_2_0_clocking_cmt_dpll_fd_cal #( parameter T_CAL         = 512    // ref clk counter for DCO calibration 
)(
...
dpss_vck190_pt_clk_wizard_2_0_clocking_Synchronizer3 Isync_rst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
   .ck (ref_clk), .rn (!rst), .q  (rst_sync_n)
   );

dpss_vck190_pt_clk_wizard_2_0_clocking_Synchronizer3 Isync_drst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
...
dpss_vck190_pt_clk_wizard_2_0_clocking_Synchronizer3 Isync_locked (
   .si (1'b0), .se (1'b0), .d  (locked_i),
   .ck (ref_clk), .rn (!rst), .q  (locked)
   );

`ifdef DEFINE_SYNC_RST
dpss_vck190_pt_clk_wizard_2_0_clocking_Synchronizer3 Isync_dco_en (
