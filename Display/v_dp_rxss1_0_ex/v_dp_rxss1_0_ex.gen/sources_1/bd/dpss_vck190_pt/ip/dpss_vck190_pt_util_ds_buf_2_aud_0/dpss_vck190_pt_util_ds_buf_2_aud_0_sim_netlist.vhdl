...
-- Date        : Thu May  9 19:10:57 2024
-- Host        : Vulcan running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Vulcan/Protocol/Display/v_dp_rxss1_0_ex/v_dp_rxss1_0_ex.gen/sources_1/bd/dpss_vck190_pt/ip/dpss_vck190_pt_util_ds_buf_2_aud_0/dpss_vck190_pt_util_ds_buf_2_aud_0_sim_netlist.vhdl
-- Design      : dpss_vck190_pt_util_ds_buf_2_aud_0
...
entity dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "ibufdsgte5";
  attribute C_MODE : string;
  attribute C_MODE of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf : entity is "util_ds_buf";
end dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf;

architecture STRUCTURE of dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf is
  signal \<const0>\ : STD_LOGIC;
  attribute box_type : string;
  attribute box_type of \USE_IBUFDS_GTE5.GEN_IBUFDS_GTE5[0].IBUFDS_GTE5_I\ : label is "PRIMITIVE";
begin
  BUFGCE_O(0) <= \<const0>\;
...
\USE_IBUFDS_GTE5.GEN_IBUFDS_GTE5[0].IBUFDS_GTE5_I\: unisim.vcomponents.IBUFDS_GTE5
    generic map(
      REFCLK_EN_TX_PATH => '0',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dpss_vck190_pt_util_ds_buf_2_aud_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_CEB : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of dpss_vck190_pt_util_ds_buf_2_aud_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of dpss_vck190_pt_util_ds_buf_2_aud_0 : entity is "dpss_vck190_pt_util_ds_buf_2_aud_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of dpss_vck190_pt_util_ds_buf_2_aud_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of dpss_vck190_pt_util_ds_buf_2_aud_0 : entity is "util_ds_buf,Vivado 2023.2";
end dpss_vck190_pt_util_ds_buf_2_aud_0;

architecture STRUCTURE of dpss_vck190_pt_util_ds_buf_2_aud_0 is
  ...
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of U0 : label is "ibufdsgte5";
  attribute C_MODE : string;
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 36864000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN dpss_vck190_pt_util_ds_buf_2_aud_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  attribute x_interface_info of IBUF_DS_P : signal is "xilinx.com:interface:diff_clock:1.0 CLK_IN_D CLK_P";
  attribute x_interface_parameter of IBUF_DS_P : signal is "XIL_INTERFACENAME CLK_IN_D, BOARD.ASSOCIATED_PARAM DIFF_CLK_IN_BOARD_INTERFACE, CAN_DEBUG false, FREQ_HZ 36864000";
  attribute x_interface_info of IBUF_OUT : signal is "xilinx.com:signal:clock:1.0 IBUF_OUT CLK";
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 36864000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN dpss_vck190_pt_util_ds_buf_2_aud_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.dpss_vck190_pt_util_ds_buf_2_aud_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
