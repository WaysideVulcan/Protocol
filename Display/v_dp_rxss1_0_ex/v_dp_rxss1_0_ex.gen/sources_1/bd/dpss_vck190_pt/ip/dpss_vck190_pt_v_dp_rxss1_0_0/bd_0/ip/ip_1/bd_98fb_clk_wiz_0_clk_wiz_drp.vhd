...
entity bd_98fb_clk_wiz_0_clk_wiz_drp is
  generic
  (
    ----------------
...
end entity bd_98fb_clk_wiz_0_clk_wiz_drp;
-------------------------------------------------------------------------------
-- Architecture Section
-------------------------------------------------------------------------------
architecture imp of bd_98fb_clk_wiz_0_clk_wiz_drp is


  component bd_98fb_clk_wiz_0_drp 
  generic (
...
begin
	...
	ram_clk_config(13)  <=    X"00000e0e";
	ram_clk_config(14)  <=    X"0000bb00";
	ram_clk_config(15)  <=    X"00000101";
...
mmcm_drp_inst: bd_98fb_clk_wiz_0_drp generic map (
  S1_CLKFBOUT_1    => X"1600",
  S1_CLKFBOUT_2    => X"0e0e",
  S1_CLKOUT0_1     => X"bb00",
  S1_CLKOUT0_2     => X"0101",
  S1_CLKOUT1_1     => X"0a00",
  S1_CLKOUT1_2     => X"0303",
