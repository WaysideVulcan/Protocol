...
module dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1316_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1316_fu_131_p2;
...
reg   [11:0] x_fu_68;
wire   [11:0] add_ln1316_fu_125_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1316_fu_131_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1316_fu_131_p2 == 1'd1))) begin
...
assign add_ln1316_fu_125_p2 = (ap_sig_allocacmp_x_8 + 12'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (bytePlanes_plane0_empty_n == 1'b0);
end
...
assign icmp_ln1316_fu_131_p2 = ((ap_sig_allocacmp_x_8 == div) ? 1'b1 : 1'b0);
...
assign m_axi_mm_video_WDATA = bytePlanes_plane0_dout;
...
endmodule //dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1316_1
