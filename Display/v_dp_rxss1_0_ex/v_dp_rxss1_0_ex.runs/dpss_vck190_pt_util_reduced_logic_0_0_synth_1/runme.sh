...
HD_PWD='c:/Vulcan/Protocol/Display/v_dp_rxss1_0_ex/v_dp_rxss1_0_ex.runs/dpss_vck190_pt_util_reduced_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpss_vck190_pt_util_reduced_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpss_vck190_pt_util_reduced_logic_0_0.tcl
