set moduleName AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_534_2
set isTopModule 0
...
set C_modelName {AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_534_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ div int 12 regular  }
	{ mm_video int 256 regular {axi_master 0}  }
	{ sext_ln534 int 27 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "div", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln534", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_mm_video_WDATA sc_out sc_lv 256 signal 1 } 
	{ m_axi_mm_video_WSTRB sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_mm_video_RDATA sc_in sc_lv 256 signal 1 } 
	{ m_axi_mm_video_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_mm_video_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_mm_video_RFIFONUM sc_in sc_lv 8 signal 1 } 
	...
	{ bytePlanes_plane1_din sc_out sc_lv 256 signal 3 } 
	{ bytePlanes_plane1_num_data_valid sc_in sc_lv 10 signal 3 } 
	{ bytePlanes_plane1_fifo_cap sc_in sc_lv 10 signal 3 } 
	{ bytePlanes_plane1_full_n sc_in sc_logic 1 signal 3 } 
	{ bytePlanes_plane1_write sc_out sc_logic 1 signal 3 } 
	{ div sc_in sc_lv 12 signal 0 } 
	{ sext_ln534 sc_in sc_lv 27 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln534", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "sext_ln534", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "2050"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "2050"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln534 { ap_none {  { sext_ln534 in_data 0 27 } } }
