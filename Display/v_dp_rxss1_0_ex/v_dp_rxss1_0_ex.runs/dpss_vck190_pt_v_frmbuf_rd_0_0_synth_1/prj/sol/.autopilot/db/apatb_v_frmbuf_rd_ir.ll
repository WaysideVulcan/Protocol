; ModuleID = 'C:/Vulcan/Protocol/Display/v_dp_rxss1_0_ex/v_dp_rxss1_0_ex.runs/dpss_vck190_pt_v_frmbuf_rd_0_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_v_frmbuf_rd_ir(i16 zeroext %width, i16 zeroext %height, i16 zeroext %stride, i16 zeroext %video_format, %"struct.ap_uint<256>"* noalias nonnull "maxi" %frm_buffer, %"struct.ap_uint<256>"* noalias nonnull "maxi" %frm_buffer2, %"struct.ap_uint<256>"* noalias nonnull "maxi" %frm_buffer3, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(32) %m_axis_video) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([2073600 x %"struct.ap_uint<256>"]* nonnull %0, [2073600 x i256]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<256>"]* nonnull %1, [2073600 x i256]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<256>"]* nonnull %2, [2073600 x i256]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* nonnull %m_axis_video, i120* nonnull align 512 %m_axis_video_copy.data, i15* nonnull align 512 %m_axis_video_copy.keep, i15* nonnull align 512 %m_axis_video_copy.strb, i1* nonnull align 512 %m_axis_video_copy.user, i1* nonnull align 512 %m_axis_video_copy.last, i1* nonnull align 512 %m_axis_video_copy.id, i1* nonnull align 512 %m_axis_video_copy.dest)
  ...
  call void @apatb_v_frmbuf_rd_hw(i16 %width, i16 %height, i16 %stride, i16 %video_format, i256* %3, i256* %4, i256* %5, i120* %m_axis_video_copy.data, i15* %m_axis_video_copy.keep, i15* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  call void @copy_back([2073600 x %"struct.ap_uint<256>"]* %0, [2073600 x i256]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<256>"]* %1, [2073600 x i256]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<256>"]* %2, [2073600 x i256]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* %m_axis_video, i120* %m_axis_video_copy.data, i15* %m_axis_video_copy.keep, i15* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>.49"(i120* align 512 %_V_data_V, i15* align 512 %_V_keep_V, i15* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* %6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<256>"([2073600 x %"struct.ap_uint<256>"]* %dst, [2073600 x %"struct.ap_uint<256>"]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %src, null
  %1 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %dst, null
  %2 = or i1 %1, %0
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [2073600 x %"struct.ap_uint<256>"], [2073600 x %"struct.ap_uint<256>"]* %src, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [2073600 x %"struct.ap_uint<256>"], [2073600 x %"struct.ap_uint<256>"]* %dst, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias %dst, i120* noalias align 512 "unpacked"="1.0" %src_V_data_V, i15* noalias align 512 "unpacked"="1.1" %src_V_keep_V, i15* noalias align 512 "unpacked"="1.2" %src_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %src_V_user_V, i1* noalias align 512 "unpacked"="1.4" %src_V_last_V, i1* noalias align 512 "unpacked"="1.5" %src_V_id_V, i1* noalias align 512 "unpacked"="1.6" %src_V_dest_V) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias nocapture, i120* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i15* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i15* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="1.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="1.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="1.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = alloca i120
  %2 = alloca i15
  %3 = alloca i15
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out([2073600 x %"struct.ap_uint<256>"]* noalias "unpacked"="0", [2073600 x i256]* noalias nocapture readonly "unpacked"="1.0", [2073600 x %"struct.ap_uint<256>"]* noalias "unpacked"="2", [2073600 x i256]* noalias nocapture readonly "unpacked"="3.0", [2073600 x %"struct.ap_uint<256>"]* noalias "unpacked"="4", [2073600 x i256]* noalias nocapture readonly "unpacked"="5.0", %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias "unpacked"="6", i120* noalias align 512 "unpacked"="7.0" %_V_data_V, i15* noalias align 512 "unpacked"="7.1" %_V_keep_V, i15* noalias align 512 "unpacked"="7.2" %_V_strb_V, i1* noalias align 512 "unpacked"="7.3" %_V_user_V, i1* noalias align 512 "unpacked"="7.4" %_V_last_V, i1* noalias align 512 "unpacked"="7.5" %_V_id_V, i1* noalias align 512 "unpacked"="7.6" %_V_dest_V) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<256>.19"([2073600 x %"struct.ap_uint<256>"]* %0, [2073600 x i256]* %1)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<256>.19"([2073600 x %"struct.ap_uint<256>"]* %2, [2073600 x i256]* %3)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<256>.19"([2073600 x %"struct.ap_uint<256>"]* %4, [2073600 x i256]* %5)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<256>.19"([2073600 x %"struct.ap_uint<256>"]* noalias "unpacked"="0" %dst, [2073600 x i256]* noalias nocapture readonly "unpacked"="1.0" %src) unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<256>.22"([2073600 x %"struct.ap_uint<256>"]* nonnull %dst, [2073600 x i256]* %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<256>.22"([2073600 x %"struct.ap_uint<256>"]* "unpacked"="0" %dst, [2073600 x i256]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<256>"([2073600 x i256]* noalias nocapture "unpacked"="0.0" %dst, [2073600 x %"struct.ap_uint<256>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<256>.29"([2073600 x i256]* %dst, [2073600 x %"struct.ap_uint<256>"]* nonnull %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<256>.29"([2073600 x i256]* nocapture "unpacked"="0.0" %dst, [2073600 x %"struct.ap_uint<256>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<256>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>.49"(i120* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i15* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i15* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_user_V, i1* noalias align 512 "unpacked"="0.4" %dst_V_last_V, i1* noalias align 512 "unpacked"="0.5" %dst_V_id_V, i1* noalias align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>.52"(i120* align 512 %dst_V_data_V, i15* align 512 %dst_V_keep_V, i15* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>.52"(i120* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i15* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i15* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="0.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="0.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
declare void @apatb_v_frmbuf_rd_hw(i16, i16, i16, i16, i256*, i256*, i256*, i120*, i15*, i15*, i1*, i1*, i1*, i1*)
...
define void @v_frmbuf_rd_hw_stub_wrapper(i16, i16, i16, i16, i256*, i256*, i256*, i120*, i15*, i15*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  call void @v_frmbuf_rd_hw_stub(i16 %0, i16 %1, i16 %2, i16 %3, %"struct.ap_uint<256>"* %21, %"struct.ap_uint<256>"* %22, %"struct.ap_uint<256>"* %23, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"* %17)
...
declare void @v_frmbuf_rd_hw_stub(i16, i16, i16, i16, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"class.hls::stream<hls::axis<ap_uint<120>, 1, 1, 1, '8', false>, 0>"*)
