...
architecture behav of dpss_vck190_pt_v_frmbuf_rd_0_0_FrmbufRdHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_colorFormat_val11_c_din : STD_LOGIC_VECTOR (1 downto 0);
    signal entry_proc_U0_colorFormat_val11_c_write : STD_LOGIC;
    ...
    signal AXIMMvideo2Bytes_U0_m_axi_mm_video_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal AXIMMvideo2Bytes_U0_m_axi_mm_video_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal AXIMMvideo2Bytes_U0_bytePlanes_plane0_din : STD_LOGIC_VECTOR (255 downto 0);
    signal AXIMMvideo2Bytes_U0_bytePlanes_plane0_write : STD_LOGIC;
    signal AXIMMvideo2Bytes_U0_bytePlanes_plane1_din : STD_LOGIC_VECTOR (255 downto 0);
    signal AXIMMvideo2Bytes_U0_bytePlanes_plane1_write : STD_LOGIC;
    signal AXIMMvideo2Bytes_U0_WidthInBytes_val10_c_din : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Bytes2MultiPixStream_U0_bytePlanes_plane0_read : STD_LOGIC;
    signal Bytes2MultiPixStream_U0_bytePlanes_plane1_read : STD_LOGIC;
    signal Bytes2MultiPixStream_U0_img_din : STD_LOGIC_VECTOR (119 downto 0);
    ...
    signal colorFormat_val11_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal colorFormat_val11_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal bytePlanes_plane1_dout : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal WidthInBytes_val10_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal WidthInBytes_val10_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal WidthInBytes_val10_c_empty_n : STD_LOGIC;
    signal img_full_n : STD_LOGIC;
    signal img_dout : STD_LOGIC_VECTOR (119 downto 0);
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        colorFormat_val11 : IN STD_LOGIC_VECTOR (1 downto 0);
        colorFormat_val11_c_din : OUT STD_LOGIC_VECTOR (1 downto 0);
        colorFormat_val11_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        colorFormat_val11_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        colorFormat_val11_c_full_n : IN STD_LOGIC;
        colorFormat_val11_c_write : OUT STD_LOGIC );
    end component;


    component dpss_vck190_pt_v_frmbuf_rd_0_0_AXIMMvideo2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        srcImg2 : IN STD_LOGIC_VECTOR (31 downto 0);
        ...
        WidthInBytes_val : IN STD_LOGIC_VECTOR (15 downto 0);
        StrideInBytes_val : IN STD_LOGIC_VECTOR (15 downto 0);
        VideoFormat_val : IN STD_LOGIC_VECTOR (5 downto 0);
        WidthInBytes_val10_c_din : OUT STD_LOGIC_VECTOR (15 downto 0);
        WidthInBytes_val10_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        WidthInBytes_val10_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        WidthInBytes_val10_c_full_n : IN STD_LOGIC;
        WidthInBytes_val10_c_write : OUT STD_LOGIC );
    end component;


    component dpss_vck190_pt_v_frmbuf_rd_0_0_Bytes2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w2_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w256_d480_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w120_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_rd_0_0_start_for_Bytes2MultiPixStream_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component dpss_vck190_pt_v_frmbuf_rd_0_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIMMvideo2Bytes_U0 : component dpss_vck190_pt_v_frmbuf_rd_0_0_AXIMMvideo2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Bytes2MultiPixStream_U0 : component dpss_vck190_pt_v_frmbuf_rd_0_0_Bytes2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2AXIvideo_U0 : component dpss_vck190_pt_v_frmbuf_rd_0_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    colorFormat_val11_c_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w2_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    bytePlanes_plane0_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w256_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane1_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w256_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_val10_c_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_fifo_w120_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2MultiPixStream_U0_U : component dpss_vck190_pt_v_frmbuf_rd_0_0_start_for_Bytes2MultiPixStream_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    m_axi_mm_video_RREADY <= AXIMMvideo2Bytes_U0_m_axi_mm_video_RREADY;
    m_axi_mm_video_WDATA <= ap_const_lv256_lc_1;
    m_axi_mm_video_WID <= ap_const_lv1_0;
    m_axi_mm_video_WLAST <= ap_const_logic_0;
    m_axi_mm_video_WSTRB <= ap_const_lv32_0;
