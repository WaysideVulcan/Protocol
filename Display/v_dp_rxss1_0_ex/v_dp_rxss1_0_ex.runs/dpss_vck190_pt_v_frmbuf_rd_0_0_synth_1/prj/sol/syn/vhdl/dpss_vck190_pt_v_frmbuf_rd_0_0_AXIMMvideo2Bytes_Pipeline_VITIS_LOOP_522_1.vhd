...
port (
    ...
    sext_ln522 : IN STD_LOGIC_VECTOR (26 downto 0) );
end;


architecture behav of dpss_vck190_pt_v_frmbuf_rd_0_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_522_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln522_fu_129_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln522_fu_129_p2 = ap_const_lv1_0))) then 
                        x_fu_68 <= add_ln522_fu_123_p2;
    ...
    add_ln522_fu_123_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_8) + unsigned(ap_const_lv12_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_mm_video_RVALID, bytePlanes_plane0_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((bytePlanes_plane0_full_n = ap_const_logic_0) or (m_axi_mm_video_RVALID = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln522_fu_129_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln522_fu_129_p2 = ap_const_lv1_1))) then 
    ...
    bytePlanes_plane0_din <= m_axi_mm_video_RDATA;
    ...
    icmp_ln522_fu_129_p2 <= "1" when (ap_sig_allocacmp_x_8 = div) else "0";
