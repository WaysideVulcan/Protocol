...
port (
    ...
    sext_ln534 : IN STD_LOGIC_VECTOR (26 downto 0) );
end;


architecture behav of dpss_vck190_pt_v_frmbuf_rd_0_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_534_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln534_fu_129_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal mm_video_blk_n_R : STD_LOGIC;
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln534_fu_129_p2 = ap_const_lv1_0))) then 
                        x_fu_68 <= add_ln534_fu_123_p2;
    ...
    add_ln534_fu_123_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_7) + unsigned(ap_const_lv12_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_mm_video_RVALID, bytePlanes_plane1_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((bytePlanes_plane1_full_n = ap_const_logic_0) or (m_axi_mm_video_RVALID = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln534_fu_129_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln534_fu_129_p2 = ap_const_lv1_1))) then 
    ...
    bytePlanes_plane1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bytePlanes_plane1_full_n, ap_block_pp0_stage0)
    begin
    ...
    bytePlanes_plane1_din <= m_axi_mm_video_RDATA;

    bytePlanes_plane1_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    icmp_ln534_fu_129_p2 <= "1" when (ap_sig_allocacmp_x_7 = div) else "0";
    ...
    m_axi_mm_video_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            m_axi_mm_video_RREADY <= ap_const_logic_1;
        else 
    ...
    mm_video_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_mm_video_RVALID, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            mm_video_blk_n_R <= m_axi_mm_video_RVALID;
        else 
            mm_video_blk_n_R <= ap_const_logic_1;
        end if; 
    end process;
