...
set C_modelArgList {
	{ axi_data_3_reload int 120 regular  }
	...
	{ axi_data_4_out int 120 regular {pointer 1}  }
	{ axi_last_4_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_3_reload", "interface" : "wire", "bitwidth" : 120, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_4_out", "interface" : "wire", "bitwidth" : 120, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_3_reload sc_in sc_lv 120 signal 0 } 
	{ select_ln306 sc_in sc_lv 1 signal 1 } 
	{ eol_reload sc_in sc_lv 1 signal 2 } 
	{ s_axis_video_TDATA sc_in sc_lv 120 signal 3 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 9 } 
	{ s_axis_video_TKEEP sc_in sc_lv 15 signal 4 } 
	{ s_axis_video_TSTRB sc_in sc_lv 15 signal 5 } 
	...
	{ axi_data_4_out sc_out sc_lv 120 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_3_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "axi_data_3_reload", "role": "default" }} , 
 	...
 	{ "name": "axi_data_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "axi_data_4_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	axi_data_3_reload { ap_none {  { axi_data_3_reload in_data 0 120 } } }
	...
	axi_data_4_out { ap_vld {  { axi_data_4_out out_data 1 120 }  { axi_data_4_out_ap_vld out_vld 1 1 } } }
