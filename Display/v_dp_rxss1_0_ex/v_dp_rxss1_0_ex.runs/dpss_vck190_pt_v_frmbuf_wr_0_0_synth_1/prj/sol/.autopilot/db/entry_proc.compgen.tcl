...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_val2 { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_val2_c9_din { O 16 vector } WidthInBytes_val2_c9_num_data_valid { I 3 vector } WidthInBytes_val2_c9_fifo_cap { I 3 vector } WidthInBytes_val2_c9_full_n { I 1 bit } WidthInBytes_val2_c9_write { O 1 bit } } \
} "
}
