...
(* CORE_GENERATION_INFO="dpss_vck190_pt_v_frmbuf_wr_0_0_v_frmbuf_wr,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvc1902-vsva2197-2MP-e-S,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.791500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=34,HLS_SYN_DSP=0,HLS_SYN_FF=9827,HLS_SYN_LUT=9161,HLS_VERSION=2023_2}" *)

module dpss_vck190_pt_v_frmbuf_wr_0_0_v_frmbuf_wr (
        ap_clk,
        ap_rst_n,
...
reg   [31:0] frm_buffer2_read_reg_348;
reg   [31:0] frm_buffer_read_reg_353;
reg   [15:0] stride_read_reg_358;
reg  signed [15:0] width_read_reg_363;
wire   [12:0] empty_fu_226_p1;
reg   [12:0] empty_reg_369;
wire   [12:0] empty_67_fu_230_p1;
reg   [12:0] empty_67_reg_374;
wire   [5:0] empty_68_fu_234_p1;
reg   [5:0] empty_68_reg_380;
wire   [15:0] mul_ln194_fu_263_p2;
reg   [15:0] mul_ln194_reg_399;
wire    ap_CS_fsm_state2;
wire   [30:0] mul_ln181_fu_287_p2;
reg   [30:0] mul_ln181_reg_404;
wire   [0:0] icmp_ln177_fu_293_p2;
reg   [0:0] icmp_ln177_reg_409;
wire   [0:0] icmp_ln177_1_fu_298_p2;
reg   [0:0] icmp_ln177_1_reg_414;
wire   [0:0] icmp_ln177_2_fu_303_p2;
reg   [0:0] icmp_ln177_2_reg_419;
wire   [0:0] icmp_ln177_3_fu_308_p2;
reg   [0:0] icmp_ln177_3_reg_424;
reg   [2:0] colorFormat_reg_429;
wire   [15:0] WidthInBytes_fu_340_p3;
reg   [15:0] WidthInBytes_reg_434;
wire    ap_CS_fsm_state3;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_AWUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WVALID;
wire   [255:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WDATA;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WSTRB;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WLAST;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WID;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_WUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_ARUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_RREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_186_m_axi_mm_video_BREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_186_ap_start;
wire    grp_FrmbufWrHlsDataFlow_fu_186_s_axis_video_TREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_186_ap_done;
wire    grp_FrmbufWrHlsDataFlow_fu_186_ap_ready;
wire    grp_FrmbufWrHlsDataFlow_fu_186_ap_idle;
reg    grp_FrmbufWrHlsDataFlow_fu_186_ap_continue;
wire    flush;
...
reg    mm_video_BREADY;
reg    grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg;
wire    ap_CS_fsm_state4;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_done;
reg    ap_block_state4_on_subcall_done;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done;
wire   [31:0] zext_ln194_fu_238_p1;
wire  signed [15:0] empty_67_fu_230_p0;
wire   [2:0] mul_ln194_fu_263_p0;
wire   [14:0] shl_ln_fu_268_p3;
wire   [14:0] mul_ln181_fu_287_p0;
wire   [16:0] mul_ln181_fu_287_p1;
wire   [13:0] tmp_fu_313_p4;
wire   [0:0] or_ln177_1_fu_330_p2;
wire   [0:0] or_ln177_fu_326_p2;
wire   [0:0] or_ln177_2_fu_334_p2;
wire   [15:0] zext_ln182_fu_322_p1;
reg   [3:0] ap_NS_fsm;
...
wire   [30:0] mul_ln181_fu_287_p00;
wire   [15:0] mul_ln194_fu_263_p00;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done = 1'b0;
end

dpss_vck190_pt_v_frmbuf_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
dpss_vck190_pt_v_frmbuf_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
dpss_vck190_pt_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_186(
    ...
    .HwReg_frm_buffer(frm_buffer_read_reg_353),
    .HwReg_frm_buffer2(frm_buffer2_read_reg_348),
    .WidthInBytes_val2(WidthInBytes_reg_434),
    .colorFormat_val3(colorFormat_reg_429),
    .width_val5(empty_67_reg_374),
    .height_val8(empty_reg_369),
    .stride_val9(stride_read_reg_358),
    .video_format_val11(empty_68_reg_380),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
dpss_vck190_pt_v_frmbuf_wr_0_0_CTRL_s_axi #(
...
dpss_vck190_pt_v_frmbuf_wr_0_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 103 ),
...
dpss_vck190_pt_v_frmbuf_wr_0_0_mul_3ns_16s_16_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 3 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
mul_3ns_16s_16_1_1_U244(
    .din0(mul_ln194_fu_263_p0),
    .din1(width_read_reg_363),
    .dout(mul_ln194_fu_263_p2)
);

dpss_vck190_pt_v_frmbuf_wr_0_0_mul_15ns_17ns_31_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 17 ),
    .dout_WIDTH( 31 ))
mul_15ns_17ns_31_1_1_U245(
    .din0(mul_ln181_fu_287_p0),
    .din1(mul_ln181_fu_287_p1),
    .dout(mul_ln181_fu_287_p2)
);

dpss_vck190_pt_v_frmbuf_wr_0_0_regslice_both #(
    .DataWidth( 120 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_186_ap_done == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_186_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg <= 1'b1;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_186_ap_ready == 1'b1)) begin
            grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        WidthInBytes_reg_434 <= WidthInBytes_fu_340_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        colorFormat_reg_429 <= MEMORY2LIVE_q0;
        icmp_ln177_1_reg_414 <= icmp_ln177_1_fu_298_p2;
        icmp_ln177_2_reg_419 <= icmp_ln177_2_fu_303_p2;
        icmp_ln177_3_reg_424 <= icmp_ln177_3_fu_308_p2;
        icmp_ln177_reg_409 <= icmp_ln177_fu_293_p2;
        mul_ln181_reg_404 <= mul_ln181_fu_287_p2;
        mul_ln194_reg_399 <= mul_ln194_fu_263_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_67_reg_374 <= empty_67_fu_230_p1;
        empty_68_reg_380 <= empty_68_fu_234_p1;
        empty_reg_369 <= empty_fu_226_p1;
        frm_buffer2_read_reg_348 <= frm_buffer2;
        frm_buffer_read_reg_353 <= frm_buffer;
        stride_read_reg_358 <= stride;
        width_read_reg_363 <= width;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_FrmbufWrHlsDataFlow_fu_186_ap_continue = 1'b1;
    end else begin
        grp_FrmbufWrHlsDataFlow_fu_186_ap_continue = 1'b0;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln194_fu_238_p1;

assign MEMORY2LIVE_address0 = zext_ln194_fu_238_p1;

assign WidthInBytes_fu_340_p3 = ((or_ln177_2_fu_334_p2[0:0] == 1'b1) ? zext_ln182_fu_322_p1 : mul_ln194_reg_399);
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_done) == 1'b0);
end
...
assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_done = (grp_FrmbufWrHlsDataFlow_fu_186_ap_done | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_done);

assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready = (grp_FrmbufWrHlsDataFlow_fu_186_ap_ready | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_186_ap_ready);

assign empty_67_fu_230_p0 = width;

assign empty_67_fu_230_p1 = empty_67_fu_230_p0[12:0];

assign empty_68_fu_234_p1 = video_format[5:0];

assign empty_fu_226_p1 = height[12:0];

assign grp_FrmbufWrHlsDataFlow_fu_186_ap_start = grp_FrmbufWrHlsDataFlow_fu_186_ap_start_reg;

assign icmp_ln177_1_fu_298_p2 = ((empty_68_reg_380 == 6'd23) ? 1'b1 : 1'b0);

assign icmp_ln177_2_fu_303_p2 = ((empty_68_reg_380 == 6'd25) ? 1'b1 : 1'b0);

assign icmp_ln177_3_fu_308_p2 = ((empty_68_reg_380 == 6'd43) ? 1'b1 : 1'b0);

assign icmp_ln177_fu_293_p2 = ((empty_68_reg_380 == 6'd22) ? 1'b1 : 1'b0);

assign mul_ln181_fu_287_p0 = mul_ln181_fu_287_p00;

assign mul_ln181_fu_287_p00 = shl_ln_fu_268_p3;

assign mul_ln181_fu_287_p1 = 31'd43691;

assign mul_ln194_fu_263_p0 = mul_ln194_fu_263_p00;

assign mul_ln194_fu_263_p00 = BYTES_PER_PIXEL_q0;

assign or_ln177_1_fu_330_p2 = (icmp_ln177_3_reg_424 | icmp_ln177_2_reg_419);

assign or_ln177_2_fu_334_p2 = (or_ln177_fu_326_p2 | or_ln177_1_fu_330_p2);

assign or_ln177_fu_326_p2 = (icmp_ln177_reg_409 | icmp_ln177_1_reg_414);

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign shl_ln_fu_268_p3 = {{empty_67_reg_374}, {2'd0}};

assign tmp_fu_313_p4 = {{mul_ln181_reg_404[30:17]}};

assign zext_ln182_fu_322_p1 = tmp_fu_313_p4;

assign zext_ln194_fu_238_p1 = video_format;


reg find_df_deadlock = 0;
// synthesis translate_off
`include "dpss_vck190_pt_v_frmbuf_wr_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "dpss_vck190_pt_v_frmbuf_wr_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //dpss_vck190_pt_v_frmbuf_wr_0_0_v_frmbuf_wr
