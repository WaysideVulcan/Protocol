...
entity dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1326_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln1326 : IN STD_LOGIC_VECTOR (26 downto 0) );
end;


architecture behav of dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1326_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1326_fu_131_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln1326_fu_125_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1326_fu_131_p2 = ap_const_lv1_0))) then 
    ...
    add_ln1326_fu_125_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_7) + unsigned(ap_const_lv12_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(bytePlanes_plane1_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (bytePlanes_plane1_empty_n = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1326_fu_131_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1326_fu_131_p2 = ap_const_lv1_1))) then 
    ...
    bytePlanes_plane1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bytePlanes_plane1_empty_n, ap_block_pp0_stage0)
    begin
    ...
    bytePlanes_plane1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    icmp_ln1326_fu_131_p2 <= "1" when (ap_sig_allocacmp_x_7 = div) else "0";
    ...
    m_axi_mm_video_WDATA <= bytePlanes_plane1_dout;
