...
entity dpss_vck190_pt_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow is
port (
...
architecture behav of dpss_vck190_pt_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_WidthInBytes_val2_c9_din : STD_LOGIC_VECTOR (15 downto 0);
    signal entry_proc_U0_WidthInBytes_val2_c9_write : STD_LOGIC;
    ...
    signal AXIvideo2MultiPixStream_U0_img_din : STD_LOGIC_VECTOR (119 downto 0);
    ...
    signal MultiPixStream2Bytes_U0_bytePlanes_plane0_din : STD_LOGIC_VECTOR (255 downto 0);
    signal MultiPixStream2Bytes_U0_bytePlanes_plane0_write : STD_LOGIC;
    signal MultiPixStream2Bytes_U0_bytePlanes_plane1_din : STD_LOGIC_VECTOR (255 downto 0);
    signal MultiPixStream2Bytes_U0_bytePlanes_plane1_write : STD_LOGIC;
    signal MultiPixStream2Bytes_U0_WidthInBytes_val_read : STD_LOGIC;
    signal MultiPixStream2Bytes_U0_WidthInBytes_val2_c_din : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Bytes2AXIMMvideo_U0_m_axi_mm_video_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal Bytes2AXIMMvideo_U0_m_axi_mm_video_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal WidthInBytes_val2_c9_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal WidthInBytes_val2_c9_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal WidthInBytes_val2_c9_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal WidthInBytes_val2_c_dout : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        WidthInBytes_val2 : IN STD_LOGIC_VECTOR (15 downto 0);
        WidthInBytes_val2_c9_din : OUT STD_LOGIC_VECTOR (15 downto 0);
        WidthInBytes_val2_c9_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        WidthInBytes_val2_c9_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        WidthInBytes_val2_c9_full_n : IN STD_LOGIC;
        WidthInBytes_val2_c9_write : OUT STD_LOGIC );
    end component;


    component dpss_vck190_pt_v_frmbuf_wr_0_0_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_MultiPixStream2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w120_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w256_d480_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component dpss_vck190_pt_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component dpss_vck190_pt_v_frmbuf_wr_0_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIvideo2MultiPixStream_U0 : component dpss_vck190_pt_v_frmbuf_wr_0_0_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2Bytes_U0 : component dpss_vck190_pt_v_frmbuf_wr_0_0_MultiPixStream2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Bytes2AXIMMvideo_U0 : component dpss_vck190_pt_v_frmbuf_wr_0_0_Bytes2AXIMMvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    HwReg_frm_buffer_c_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    HwReg_frm_buffer2_c_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_val2_c9_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w120_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane0_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w256_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane1_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w256_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_val2_c_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2Bytes_U0_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2AXIMMvideo_U0_U : component dpss_vck190_pt_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
