...
HD_PWD='c:/Vulcan/Protocol/Display/v_dp_rxss1_0_ex/v_dp_rxss1_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dpss_vck190_pt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dpss_vck190_pt_wrapper.tcl -notrace
