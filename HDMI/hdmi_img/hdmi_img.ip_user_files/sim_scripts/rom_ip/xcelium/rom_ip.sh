...
#
# Script generated by Vivado on Fri Apr 26 22:49:24 +0800 2024
...
#
# Usage        : rom_ip.sh
#                rom_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom_ip.sh [-reset_run]
#                rom_ip.sh [-reset_log]
#                rom_ip.sh [-help]
#
...
#                script (type 'rom_ip.sh -help' for more information).
#
...
# script info
echo -e "rom_ip.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rom_ip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rom_ip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rom_ip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: rom_ip.sh [-step]\n\
Usage: rom_ip.sh [-lib_map_path]\n\
Usage: rom_ip.sh [-reset_run]\n\
Usage: rom_ip.sh [-reset_log]\n\
Usage: rom_ip.sh [-keep_index]\n\
