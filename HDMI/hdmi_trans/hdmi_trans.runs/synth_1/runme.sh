...
HD_PWD='C:/Vulcan/Protocol/HDMI/hdmi_trans/hdmi_trans.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_trans_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_trans_top.tcl
