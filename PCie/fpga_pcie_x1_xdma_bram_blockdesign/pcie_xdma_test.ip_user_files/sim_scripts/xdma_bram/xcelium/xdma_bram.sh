...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_7 -libname xdma_v4_1_26 -libname axi_bram_ctrl_v4_1_9 -libname xlconstant_v1_1_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib blk_mem_gen_v8_4_7 xdma_v4_1_26 axi_bram_ctrl_v4_1_9 xlconstant_v1_1_8)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xdma_v4_1_26 $xmvlog_opts -sv +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/xdma_v4_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../pcie_xdma_test.gen/sources_1/bd/xdma_bram/ipshared/7f37/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xdma_bram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xdma_bram -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xdma_bram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
