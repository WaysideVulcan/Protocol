...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_1_26"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_7 -L xdma_v4_1_26 -L axi_bram_ctrl_v4_1_9 -L xlconstant_v1_1_8 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xdma_bram xil_defaultlib.xdma_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xdma_bram -key {Behavioral:sim_1:Functional:xdma_bram} -tclbatch cmd.tcl -protoinst "protoinst_files/xdma_bram.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xdma_bram.wdb xsim.dir libdpi.so)
