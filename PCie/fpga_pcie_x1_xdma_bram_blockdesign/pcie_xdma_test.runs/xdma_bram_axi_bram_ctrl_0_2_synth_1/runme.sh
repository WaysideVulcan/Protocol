...
HD_PWD='C:/Vulcan/Protocol/PCie/fpga_pcie_x1_xdma_bram_blockdesign/pcie_xdma_test.runs/xdma_bram_axi_bram_ctrl_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_bram_axi_bram_ctrl_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_bram_axi_bram_ctrl_0_2.tcl
