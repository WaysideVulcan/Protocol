...
HD_PWD='C:/Vulcan/Protocol/PCie/fpga_pcie_x1_xdma_bram_blockdesign/pcie_xdma_test.runs/xdma_bram_xdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_bram_xdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_bram_xdma_0_0.tcl
