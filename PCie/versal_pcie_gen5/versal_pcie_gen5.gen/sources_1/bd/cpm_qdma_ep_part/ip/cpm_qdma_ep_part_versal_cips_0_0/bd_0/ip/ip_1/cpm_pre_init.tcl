...
set cpm_clock_init_data {
    ...
    mask_write 0XFCDC0100 0x0203FF00 0x02000200
		...
		# 10 bit divider
		# CPM5_CRX_CPM5_DBG_REF_CTRL_DIVISOR0                                             6

		# Clock active signal. 0 = disable the clock. 1 = enable the clock.
		# CPM5_CRX_CPM5_DBG_REF_CTRL_CLKACT                                               1

		# Enable and Divider controls for cpm_dbg_clk. All SOC Debug features run on this clock
		#(OFFSET, MASK, VALUE)      (0XFCDC0108, 0x0203FF00U ,0x02000600U)  */
    mask_write 0XFCDC0108 0x0203FF00 0x02000600
    ...
    mask_write 0XFCDC0110 0x0203FF00 0x02000200
		...
		# 10 bit divider
		# CPM5_CRX_CPM5_AUX1_REF_CTRL_DIVISOR0                                            15

		# Clock active signal. 0 = disable the clock. 1 = enable the clock.
		# CPM5_CRX_CPM5_AUX1_REF_CTRL_CLKACT                                              1

		# Enable and Divider controls for cpm_aux1_clk.
		#(OFFSET, MASK, VALUE)      (0XFCDC0114, 0x0203FF00U ,0x02000F00U)  */
    mask_write 0XFCDC0114 0x0203FF00 0x02000F00
