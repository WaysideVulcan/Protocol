...
cpm5_v1_0_14_versal_smsw_sys_clk_gen_ps #(.offset(7500),.halfcycle(500))  clk_gen_1000_1 (.sys_clk(clk_1000_1));
cpm5_v1_0_14_versal_smsw_sys_clk_gen_ps #(.offset(7000),.halfcycle(1000)) clk_gen_500_1  (.sys_clk(clk_500_1));
cpm5_v1_0_14_versal_smsw_sys_clk_gen_ps #(.offset(6000),.halfcycle(2000)) clk_gen_250_1  (.sys_clk(clk_250_1));
cpm5_v1_0_14_versal_smsw_sys_clk_gen_ps #(.offset(4000),.halfcycle(4000)) clk_gen_125_1  (.sys_clk(clk_125_1));
cpm5_v1_0_14_versal_smsw_sys_clk_gen_ps #(.offset(0000),.halfcycle(8000)) clk_gen_62_5_1 (.sys_clk(clk_62_5_1));
