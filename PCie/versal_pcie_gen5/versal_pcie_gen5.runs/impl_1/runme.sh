...
HD_PWD='C:/Vulcan/Protocol/PCie/versal_pcie_gen5/versal_pcie_gen5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpm_qdma_ep_part_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpm_qdma_ep_part_wrapper.tcl -notrace
