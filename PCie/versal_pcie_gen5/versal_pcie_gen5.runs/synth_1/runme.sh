...
HD_PWD='C:/Vulcan/Protocol/PCie/versal_pcie_gen5/versal_pcie_gen5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpm_qdma_ep_part_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpm_qdma_ep_part_wrapper.tcl
