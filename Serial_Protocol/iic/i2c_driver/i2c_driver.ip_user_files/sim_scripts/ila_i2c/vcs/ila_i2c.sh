...
#
# Script generated by Vivado on Tue May 07 15:37:19 +0800 2024
...
#
# Usage        : ila_i2c.sh
#                ila_i2c.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_i2c.sh [-reset_run]
#                ila_i2c.sh [-reset_log]
#                ila_i2c.sh [-help]
#
...
#                script (type 'ila_i2c.sh -help' for more information).
#
...
# script info
echo -e "ila_i2c.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_i2c.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../i2c_driver.gen/sources_1/ip/ila_i2c/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../i2c_driver.gen/sources_1/ip/ila_i2c/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_i2c xil_defaultlib.glbl -o ila_i2c_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_i2c_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_i2c_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_i2c_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_i2c.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_i2c.sh [-help]\n\
Usage: ila_i2c.sh [-step]\n\
Usage: ila_i2c.sh [-lib_map_path]\n\
Usage: ila_i2c.sh [-reset_run]\n\
Usage: ila_i2c.sh [-reset_log]\n\
Usage: ila_i2c.sh [-keep_index]\n\
Usage: ila_i2c.sh [-noclean_files]\n\n\
