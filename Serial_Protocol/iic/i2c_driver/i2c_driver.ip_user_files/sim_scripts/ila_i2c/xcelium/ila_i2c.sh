...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../i2c_driver.gen/sources_1/ip/ila_i2c/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../i2c_driver.gen/sources_1/ip/ila_i2c/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_i2c xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_i2c -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_i2c_sc.so .tmp_log xcelium_lib waves.shm c.obj)
