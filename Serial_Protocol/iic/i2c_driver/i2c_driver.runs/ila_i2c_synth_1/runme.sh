...
HD_PWD='C:/Vulcan/Protocol/Serial_Protocol/iic/i2c_driver/i2c_driver.runs/ila_i2c_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_i2c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_i2c.tcl
