...
HD_PWD='C:/Vulcan/Protocol/Serial_Protocol/iic/i2c_driver/i2c_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_cfg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_cfg.tcl
